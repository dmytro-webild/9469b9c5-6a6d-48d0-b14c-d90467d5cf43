...
export default function LandingPage() {
  ...
  <div id="services" data-section="services">
      ...
      features={[
        ...
        {
          title: "AI Chatbots",          description: "Intelligent, human-like virtual agents for 24/7 customer support.",          phoneOne: { imageSrc: "http://img.b2bpic.net/free-vector/chatbot-conversation-vectorart_78370-4107.jpg", imageAlt: "chat bot technology icon" },
  ...
  <div id="metrics" data-section="metrics">
      ...
      metrics={[
        {
          id: "1",          value: "120+",          title: "Hours Saved Monthly",          items: ["Per average client", "Automated workflows"]
        },
        {
          id: "2",          value: "3X",          title: "Lead Growth",          items: ["Conversion optimization", "Data driven results"]
        },
        {
          id: "3",          value: "24/7",          title: "Smart Support",          items: ["Constant monitoring", "Always online"]
        }
      ]}
  ...
  <div id="portfolio" data-section="portfolio">
      ...
      products={[
        ...
        { id: "p5", name: "E-commerce Voice", price: "Premium UX", imageSrc: "http://img.b2bpic.net/free-photo/modern-equipped-computer-lab_23-2149241197.jpg" },
        { id: "p6", name: "Marketing Automation", price: "3X Growth", imageSrc: "http://img.b2bpic.net/free-photo/upload-icon-front-side_187299-45737.jpg" }
      ]}
      title="Case Studies"
  ...
  <div id="testimonials" data-section="testimonials">
      ...
      useInvertedBackground={false}
      testimonials={[
        { id: "1", name: "Sarah J.", role: "CEO", company: "TechStream", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/old-man-standing-office-with-laptop_1157-33379.jpg" },
        { id: "2", name: "Mark D.", role: "CTO", company: "CloudFlow", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/portrait-bearded-black-man-wool-suit_613910-15972.jpg" },
        { id: "3", name: "Elena R.", role: "Founder", company: "Innovate", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/manager-sitting-office_1098-22033.jpg" },
        { id: "4", name: "James L.", role: "Director", company: "GrowthX", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/businessman-smiling-looking-camera_23-2148112827.jpg" },
        { id: "5", name: "Sophie K.", role: "VP", company: "DigitalCore", rating: 5, imageSrc: "http://img.b2bpic.net/free-photo/senior-man-using-laptop-tablet-same-time_482257-8141.jpg" }
      ]}
